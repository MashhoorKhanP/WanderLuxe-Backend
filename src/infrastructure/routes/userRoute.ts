...
router.get("/find-banners", (req, res) =>
...
router.get("/find-coupons", (req, res) =>
...
router.post("/add-money-to-wallet", (req, res) =>
  userController.addMoneyToWallet(req, res)
);
router.post("/wallet/webhook", (req, res) =>
  userController.walletWebhook(req, res)
);
router.get("/updated-user/:userId", (req, res) =>
  userController.getUpdatedUser(req, res)
);

//chat
router.post("/conversation", (req, res) =>
  userController.newConversation(req, res)
);
router.get("/get-conversations/:userId", (req, res) =>
  userController.getConversations(req, res)
);
